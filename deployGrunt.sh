...
# --------------------------------------------------------------------------------
# KUDU Deployment Script that runs grunt as pre-deployment task
# 
# The detailed description about running grunt as part of the Web Site deployment 
# process can be found in the following blog post:
